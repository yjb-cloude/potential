...
- **阶段**：自动化测试补齐 + 项目实战
- **目标**：2027 年 3-4 月开始面试
- **最近学习**：Python 自动化测试基础（JSON/文件读写/异常处理/pytest 入门）
- **最后更新**：2026-09-20
...
| 月份 | 阶段 | 目标 |
|------|------|------|
| 2026-09 ~ 10 | 自动化测试补齐 | Selenium POM + pytest 接口自动化 + Rest Assured |
| 2026-11 | AI + 项目实战 | AI 测试用例生成器（一个 AI 项目就够） |
| 2026-12 | 框架 + Docker + CI/CD | 自动化框架完善 + GitHub 项目打磨 |
| 2027-01 | 性能测试 + 安全测试基础 | JMeter + 安全概念扫盲 |
| 2027-02 | 面试题系统刷 + 模拟面试 | 测试/Java/AI 面试题全过一遍 |
| 2027-03 ~ 04 | 投简历 + 真实面试 | 边面边补 |
